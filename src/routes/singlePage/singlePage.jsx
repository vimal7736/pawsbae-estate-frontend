        ...
        <div className="wrapper">
          ...
          <div className="listVertical">
            <div className="feature">
              ...
              <div className="featureText">
                <span>Utilities</span>
                {
                  post.postDetail.utilities === "owner" ? (<p>Owner is responsible</p>) : (<p>Owner is responsible</p>)
                }
              </div>
            </div>
            <div className="feature">
              ...
              <div className="featureText">
                ...
                {post.postDetail.pet === "allowed" ?(<p>Allowed</p>):(<p>Not Allowed</p>)}
              </div>
            </div>
            <div className="feature">
              <img src="/fee.png" alt="" />
          ...
          <div className="listHorizontal">
            ...
            <div className="feature">
              ...
              <div className="featureText">
                <span>Bus Stop</span>
                <p>{post.postDetail.bus >999? post.postDetail.bus/1000 + "km":post.postDetail.restaurant + "m"} away</p>
              </div>
            </div>
            <div className="feature">
              <img src="/fee.png" alt="" />
